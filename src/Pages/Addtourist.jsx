...
<div>
  ...
  <div  className="relative z-0 w-full mb-5 group">
      <select type="text" name="country" id="countryname"  className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-500 dark:focus:border-cyan-500 focus:outline-none focus:ring-0 focus:border-cyan-500 peer" placeholder=" " required >
  ...
  <div  className="grid md:grid-cols-2 md:gap-6">
    <div  className="relative z-0 w-full mb-5 group">
        <input defaultValue={user.email} type="email"  name="email" id="phone6"  className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-500 dark:focus:border-cyan-500 focus:outline-none focus:ring-0 focus:border-cyan-500 peer" placeholder=" " required />
    ...
    <div  className="relative z-0 w-full mb-5 group">
        <input defaultValue={user.displayName} type="text" name="username" id="company7"  className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-500 dark:focus:border-cyan-500 focus:outline-none focus:ring-0 focus:border-cyan-500 peer" placeholder=" " required />
  ...
  <button type="submit"  className="text-black focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-cyan-400 hover:bg-cyan-500 dark:focus:ring-cyan-800">Add</button>
</form>
<Footer></Footer>
</div>
