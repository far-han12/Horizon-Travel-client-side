...
<div>
  ...
  <div  className="relative z-0 w-full mb-5 group">
      <input type="text" name="name" id="name"  className="block py-2.5 px-0 w-full text-sm text-black 
  ...
  <div  className="relative z-0 w-full mb-5 group">
      <select type="text" name="country" id="countryname"  className="block py-2.5 px-0 w-full text-sm  bg-transparent border-0 border-b-2 border-gray-300 appearance-none text-black 
      dark:text-white dark:border-gray-500 dark:focus:border-cyan-500 focus:outline-none focus:ring-0 focus:border-cyan-500 peer" placeholder=" " required >
  ...
  <div  className="grid md:grid-cols-2 md:gap-6">
    <div  className="relative z-0 w-full mb-5 group">
        <input type="text" name="seasonality" id="first_name4"  className="block py-2.5 px-0 w-full text-sm  bg-transparent border-0 border-b-2 border-gray-300 appearance-none text-black 
      dark:text-whitedark:border-gray-500 dark:focus:border-cyan-500 focus:outline-none focus:ring-0 focus:border-cyan-500 peer" placeholder=" " required />
