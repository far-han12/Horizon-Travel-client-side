    ...
    return (
		...
		<Carousel className='py-4' responsive={responsive} rewind={false}  infinite={true} autoPlay={true} autoPlaySpeed={1000} arrows={false} >
            {reviews.map((review, index) => (
                <div key={index} className="container overflow-hidden mx-auto space-x-2  text-black flex flex-col h-full  w-[300px] md:w-[350px] lg:w-[400px] p-4  divide-y rounded-md dark:divide-gray-300 bg-gray-200  dark:text-gray-800">
