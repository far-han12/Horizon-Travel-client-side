...
<h2 className='font-medium text-xl lg:text-2xl text-center mt-5 mb-3 lg:mb-5'>Plan Your Perfect Trip with Intelligent Recommendations and Insights</h2>
      ...
      className="w-full  mx-auto  text-center rounded-lg shadow-lg   py-6 px-4 transition-all duration-500 transform hover:scale-105"
    >
    ...
    <div className="w-full mx-auto text-center rounded-lg    my-4 shadow-lg transition-all duration-500 transform hover:scale-105">
